...
:if ($enableCapsman = "true") do={
  ...
  /interface wifi security add name=sec-core authentication-types=wpa2-psk,wpa3-psk passphrase=$secCorePass
  ...
  /interface wifi channel add name=ch-5g band=5ghz-ax frequency=5180,5200,5220,5240,5745,5765,5785,5805,5825 width=80mhz
  /interface wifi channel add name=ch-2g band=2ghz-ax frequency=2412,2437,2462 width=20mhz
  ...
  /interface wifi configuration add name=cfg-core-5g ssid=$ssidCore security=sec-core datapath=dp-core channel=ch-5g mode=ap
  /interface wifi configuration add name=cfg-core-2g ssid=$ssidCore security=sec-core datapath=dp-core channel=ch-2g mode=ap
  ...
  /interface wifi provisioning add action=create-enabled master-configuration=cfg-core-2g supported-bands=2ghz-ax
} else={
