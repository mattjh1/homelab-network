...
/ip pool add name=pool-work ranges=192.168.40.40-192.168.40.254
...
/ip dhcp-server add name=dhcp-work interface=vlan-work address-pool=pool-work
...
/ip dhcp-server network add address=192.168.40.0/24 gateway=192.168.40.1 dns-server=$adguardDns
