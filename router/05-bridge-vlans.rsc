...
/interface bridge port add bridge=$lanBridge interface=$mgmtAccessPort frame-types=admit-only-untagged-and-priority-tagged pvid=10
...
/interface bridge vlan add bridge=$lanBridge vlan-ids=10 tagged=$lanBridge,$apTrunkPort untagged=$mgmtAccessPort
